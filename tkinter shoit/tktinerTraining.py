...
def on_button_pressed6():
    ...
    tttSLOT1 = tk.Label(master=tttWin,image=emptyimage)
    tttSLOT1.grid(row=0, column=0)
    tttSLOT2 = tk.Label(master=tttWin,image=emptyimage)
    tttSLOT2.grid(row=0, column=1)
    tttSLOT3 = tk.Label(master=tttWin,image=emptyimage)
    tttSLOT3.grid(row=0, column=2)
    tttSLOT4 = tk.Label(master=tttWin,image=emptyimage)
    tttSLOT4.grid(row=1, column=0)
    tttSLOT5 = tk.Label(master=tttWin,image=emptyimage)
    tttSLOT5.grid(row=1, column=1)
    tttSLOT6 = tk.Label(master=tttWin,image=emptyimage)
    tttSLOT6.grid(row=1, column=2)
    tttSLOT7 = tk.Label(master=tttWin,image=emptyimage)
    tttSLOT7.grid(row=2, column=0)
    tttSLOT8 = tk.Label(master=tttWin,image=emptyimage)
    tttSLOT8.grid(row=2, column=1)
    tttSLOT9 = tk.Label(master=tttWin,image=emptyimage)
    tttSLOT9.grid(row=2, column=2)
